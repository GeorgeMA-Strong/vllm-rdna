...
def _annotate_eagle_groups(
    ...
    3. If neither rule marked a group, a separately prefixed drafter following
       the target marks every group containing one of its layers. Ambiguous
       registration order and drafters sharing the target prefix retain the
